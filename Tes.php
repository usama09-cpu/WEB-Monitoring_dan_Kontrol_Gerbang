           ...
           <div class="card text-black mb-3" style="width: 15rem; margin-right: 15px;">
              <div class="card-header" style="font-size: 30px; text-align: center; background-color: red; color: white;">Manual Control</div>
                <div class="card-body">
                  ...
                  <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" onchange="ubahstatus4(this.checked)" <?php 
                    if($manualControl==1) echo "checked";
                  ?>>
                  <label class="form-check-label" for="flexSwitchCheckDefault"> <span id="status4"><?php 
              ...
              <div class="card-header" style="font-size: 30px; text-align: center; background-color: red; color: white;">PINTU AIR 1</div>
                <div class="card-body">
                  ...
                  <label class="form-check-label" for="flexSwitchCheckDefault"> <span id="status1"><?php 
                    if($relay==1) echo "Terbuka"; else echo "Tertutp";
                  ?> </span>  </label>
                  </div>
                </div>
          </div> 
